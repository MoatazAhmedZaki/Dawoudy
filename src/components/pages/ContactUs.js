...
class ContactUs extends Component {
  ...
  validateForm() {
    this.setState({
      formValid: this.state.emailValid && this.state.nameValid && this.state.numberValid
    });
  }
  errorClass(error) {
    if (error) {
          ...
          <div style={{ display: 'flex' }}>
            <Row className="contacticonsrow">
              <Col sm="12" md="6" lg="4" className="icondivcontacthome">
                <Row>
                  <Col sm="2">
                  <i class="fas fa-phone fa-4x" style={{color:"#243462"}}></i>
                  </Col>
                  <Col
                    sm="10"
...
>
              ...
              <Col sm="12" md="6" lg="4" className="icondivcontacthome">
                <Row>
                  <Col sm="2">
                  <i class="fas fa-map-marker-alt fa-4x" style={{color:"#243462"}}></i>
                  </Col>
                  <Col
                    sm="10"
                    style={{ paddingTop: '15px' }}
...
>
              ...
              <Col sm="12" md="6" lg="4" className="icondivcontacthome">
                <Row>
                  <Col sm="2">
                  <i class="fas fa-envelope fa-4x" style={{color:"#243462"}}></i>
                  </Col>
                  <Col
                    sm="10"
                    style={{ paddingTop: '15px' }}
        ...
        <Container className="formamp">
          <Row>
            <Col md="12" lg="5" className="reachform">
              <h5>
              {this.state.text.reach}



              </h5>
              <p className="reachus-paragraph">
              {this.state.text.reach2}
