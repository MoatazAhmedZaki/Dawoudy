      ...
      <section className="footer">
        <div className="footerLinks">
          <Container>
            <Row className="footerRow">
              <Col sm={12} md={7}>
                <ul className="py-4 footerlinksnav">
                  <li>
                    <Link to="/"> {this.state.text.navbarhome}</Link>
                  </li>

                  <li>
                    <Link to="/services"> {this.state.text.navbarservice}</Link>
                  </li>
                  <li>
              ...
              <Col sm={12} md={4}>
                <ul
                  style={{ textAlign: 'end' }}
                  className="py-4 footerlinksnav"
                >
                  <li>
                    <Link style={{ padding:"10px",fontSize: '12px', marginTop: '5px' ,
               borderBottomRightRadius:"100px", borderBottomLeftRadius:"100px" ,
               position:"relative", top:"2px"
            
            }}
                                className={"px-2 " + (this.props.language === 'ar' ? 'lanStyle' : '')}

                     onClick={this.onChange} id="ar"
                     >
                      عربي
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link onClick={this.onChange} id="en"   style={{ padding:"10px",fontSize: '12px', marginTop: '5px' ,
               borderBottomRightRadius:"100px", borderBottomLeftRadius:"100px" ,
               position:"relative", top:"2px"
        ...
        <div className="footerbg pt-3 pb-5">
          <Container>
            <Row className="footerTxt pt-5 px-3">
              ...
              className={"m-auto text-center "+ (this.props.language === 'en' ? '' : 'withoutletterspace')}
              >
              {this.state.text.SUB}
            ...
            <Row >
              ...
              <Col sm={12}  >
                ...
                <Button
                  ...
                  className={"footerBtn mt-4  mb-5 py-2  " +(this.props.language === 'en' ? '' : 'withoutletterspace')}
                >
          ...
          <div>
            ...
            <p 
              className={"m-auto  right  " +(this.props.language === 'en' ? 'text-left' : 'text-right')}
        ...
        <div className="footerLinks">
          <Container>
            ...
            className={"cpyRight py-3 "+ (this.props.language === 'en' ? '' : 'withoutletterspace')}

            >
              
              
              
              {this.state.text.footerRights}</p>
          </Container>
        </div>
      </section>
    );
