...
>{this.state.text.homegingertips}</h6>
          <p className={(this.props.language === 'en' ? '' : 'withoutletterspace')}>{this.state.text.homeourbusiness}</p>{' '}
          <Link to="/services">
            {' '}
        ...
        <Container fluid className="fingertips-grid">
          <Row>
            <Col sm="12" md="4" className="mission">
              <h5 className={(this.props.language === 'en' ? '' : 'withoutletterspace')} >{this.state.text.homemissionheader}</h5>
              <div className="missionicon  text-center">
                {/* <img
                  alt="icon"
                  src="https://dawoudy.s3.eu-central-1.amazonaws.com/missionIcon.png"
                /> */}

<i class="far fa-bullseye "></i>
<i class="fas fa-bullseye fa-4x py-3"  style={{color:"white"}}></i>
              </div>
              <p className={(this.props.language === 'en' ? '' : 'withoutletterspace')}>
            ...
            <Col sm="12" md="4" className="about">
              <h5 className={(this.props.language === 'en' ? '' : 'withoutletterspace')} >{this.state.text.homeaboutheader}</h5>
              ...
              <div class="d-flex justify-content-center aboutbtn">
                <Button className="aboutusbtn ">
                  <Link to="/about" className={(this.props.language === 'en' ? '' : 'withoutletterspace')}> {this.state.text.ABOUT_US} </Link>
                </Button>
              </div>
            </Col>

            <Col sm="12" md="4" className="vision">
              <h5 className={(this.props.language === 'en' ? '' : 'withoutletterspace')}>{this.state.text.homevisionheader}</h5>
              <div className="missionicon  text-center">
             

              <i class="far fa-eye fa-4x py-3"  style={{color:"white"}}></i>
              </div>
