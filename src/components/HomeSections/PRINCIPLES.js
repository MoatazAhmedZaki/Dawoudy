          ...
          <Container>
            <Row className="">
              <Col sm={1}>
                {/* <img
                  alt="Target"
                  src="https://dawoudy.s3.eu-central-1.amazonaws.com/target2.png"
                  className="img-fluid "
                /> */}
          ...
          <Col md={10} sm={10} className="col10principle p-0 mx-auto ">
            <div className="ourpriciplesIcons">
              ...
              <Row className="py-5">
                ...
                <i class="fas fa-business-time py-3 fa-4x" style={{color:"#223362"}}></i>
                ...
                <i class="fas fa-clipboard-list py-3 fa-4x" style={{color:"#223362"}}></i>
                  <p
                    className={
                      this.props.language === "en" ? "" : "withoutletterspace"
                    }
                ...
                <Col sm={4} className="text-center  px-2">
                <i class="fas fa-door-closed py-3 fa-4x" style={{color:"#223362"}}></i>
                  <p
                    className={
                      this.props.language === "en" ? "" : "withoutletterspace"
                    }
            ...
            <section className="PARTNERS par">
                ...
                <Col md={3}>
                  <Row>
                    <img
                      ...
                      alt="logo"
                      src="https://cdn5.vectorstock.com/i/thumb-large/76/79/your-logo-here-placeholder-symbol-vector-26077679.jpg"
                    />
                  </Row>
                </Col>
                <Col md={3}>
